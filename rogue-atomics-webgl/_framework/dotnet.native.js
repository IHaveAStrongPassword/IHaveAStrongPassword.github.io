...
// end include: preamble.js
  ...
  var DOTNET = {setup:function setup(emscriptenBuildOptions) {
  ...
  function _mono_wasm_bind_js_import(
  ) {
  return {runtime_idx:22};//mono_wasm_bind_js_import
  }
  ...
  return {runtime_idx:28};//mono_wasm_change_case
  }

  function _mono_wasm_change_case_invariant(
  ) {
  return {runtime_idx:27};//mono_wasm_change_case_invariant
  }

  function _mono_wasm_compare_string(
  ) {
  return {runtime_idx:29};//mono_wasm_compare_string
  }
  ...
  return {runtime_idx:31};//mono_wasm_ends_with
  }
  ...
  return {runtime_idx:33};//mono_wasm_get_calendar_info
  }

  function _mono_wasm_get_culture_info(
  ) {
  return {runtime_idx:34};//mono_wasm_get_culture_info
  }

  function _mono_wasm_get_first_day_of_week(
  ) {
  return {runtime_idx:35};//mono_wasm_get_first_day_of_week
  }

  function _mono_wasm_get_first_week_of_year(
  ) {
  return {runtime_idx:36};//mono_wasm_get_first_week_of_year
  }

  function _mono_wasm_index_of(
  ) {
  return {runtime_idx:32};//mono_wasm_index_of
  }
  ...
  return {runtime_idx:30};//mono_wasm_starts_with
  }
...
var __miniTempWebGLIntBuffersStorage = new Int32Array(288);
  ...
  ;
DOTNET.setup({ wasmEnableSIMD: false,wasmEnableEH: true,enableAotProfiler: false, enableBrowserProfiler: false, runAOTCompilation: true, wasmEnableThreads: false, gitHash: "8e5e748c5c06d3e40244c725bd2124f06998f6c1", });;
...
var wasmImports = {
  ...
  "mono_wasm_bind_js_import": _mono_wasm_bind_js_import,
